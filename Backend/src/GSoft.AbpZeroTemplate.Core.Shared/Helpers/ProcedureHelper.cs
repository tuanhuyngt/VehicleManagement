...
namespace GSoft.AbpZeroTemplate.Helpers
{
    ...
    public class ProcedureHelper : IProcedureHelper
    {
        ...
        {
            connectionString = "Server=tcp:tuanhuyngt.database.windows.net,1433;Initial Catalog=CarManagement;Persist Security Info=False;User ID=tuanhuyngt;Password=tHuy456456;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
        }
